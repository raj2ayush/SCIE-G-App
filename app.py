...
def ttieEncrypt(text, len, private_key):
    ...
    ttieImage.save('/Users/ayushraj/Desktop/Projects /Cyber Project/Chat-WebApp-Using-TTIE-and-GeolocationProtection-main/SavedImagesLogs/ttieOutput.png')
    ...
    ttieImage.save('/Users/ayushraj/Desktop/Projects /Cyber Project/Chat-WebApp-Using-TTIE-and-GeolocationProtection-main/SavedImagesLogs/ttieOutput2.png')
    return ttieImage
...
img = cv2.imread(r"/Users/ayushraj/Desktop/Projects /Cyber Project/Chat-WebApp-Using-TTIE-and-GeolocationProtection-main/SavedImagesLogs/ttieOutput2.png", 1)
...
def handle_send_message_event(data):
    ...
    cv2.imwrite(r"/Users/ayushraj/Desktop/Projects /Cyber Project/Chat-WebApp-Using-TTIE-and-GeolocationProtection-main/SavedImagesLogs/ttieOutput2Enc.png", EncryptionImg)

    # =========================================
    # IMAGE DECRYPTION
    img = cv2.imread(r"/Users/ayushraj/Desktop/Projects /Cyber Project/Chat-WebApp-Using-TTIE-and-GeolocationProtection-main/SavedImagesLogs/ttieOutput2Enc.png", 1)
    DecryptionImg = np.zeros(img.shape, np.uint8)
    imageDecryption(img, 10, 30, 0.123345, DecryptionImg)

    # Saving the Decrypted Image
    cv2.imwrite(r"/Users/ayushraj/Desktop/Projects /Cyber Project/Chat-WebApp-Using-TTIE-and-GeolocationProtection-main/SavedImagesLogs/ttieOutput2Dec.png", DecryptionImg)
